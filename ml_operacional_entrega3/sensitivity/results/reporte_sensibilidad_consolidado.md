...
Las nuevas metricas en dias hacen que el analisis sea mas clinico. No solo sabemos cuantos falsos negativos hay; tambien sabemos que esos falsos negativos tienen descalces promedio cercanos a 15 dias. En palabras simples, cuando el sistema no alerta a un paciente que realmente sera PLOS, el error no es pequeno: suele implicar una diferencia de varias jornadas hospitalarias. Por eso, los falsos negativos son operacionalmente graves. En cambio, los falsos positivos generan falsas alertas con errores promedio menores, pero igualmente relevantes porque pueden inducir sobrerreserva de camas.
